...
FORTRAN_CALLSPEC void F_FUNC(cgees_c,CGEES_C)(fw_character_t *, fw_character_t *, void *, fwi_integer_t *, fw_shape_t *, fwc_complex_t *, fwi_integer_t *, fwi_integer_t *, fw_shape_t *, fwc_complex_t *, fw_shape_t *, fwc_complex_t *, fwi_integer_t *, fw_shape_t *, fwc_complex_t *, fwi_integer_t *, fw_shape_t *, fwr_real_t *, fw_shape_t *, fwl_logical_t *, fwi_integer_t *, fwi_integer_t *, fw_character_t *);
...
FORTRAN_CALLSPEC void F_FUNC(sgees_c,SGEES_C)(fw_character_t *, fw_character_t *, void *, fwi_integer_t *, fw_shape_t *, fwr_real_t *, fwi_integer_t *, fwi_integer_t *, fw_shape_t *, fwr_real_t *, fw_shape_t *, fwr_real_t *, fw_shape_t *, fwr_real_t *, fwi_integer_t *, fw_shape_t *, fwr_real_t *, fwi_integer_t *, fw_shape_t *, fwl_logical_t *, fwi_integer_t *, fwi_integer_t *, fw_character_t *);
...
FORTRAN_CALLSPEC void F_FUNC(zgees_c,ZGEES_C)(fw_character_t *, fw_character_t *, void *, fwi_integer_t *, fw_shape_t *, fwc_complex_x16_t *, fwi_integer_t *, fwi_integer_t *, fw_shape_t *, fwc_complex_x16_t *, fw_shape_t *, fwc_complex_x16_t *, fwi_integer_t *, fw_shape_t *, fwc_complex_x16_t *, fwi_integer_t *, fw_shape_t *, fwr_dbl_t *, fw_shape_t *, fwl_logical_t *, fwi_integer_t *, fwi_integer_t *, fw_character_t *);
