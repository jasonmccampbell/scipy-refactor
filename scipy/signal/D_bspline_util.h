...
int D_cubic_spline2D(double*, double*, int, int, double, npy_intp*, npy_intp*,
                     double);
int D_quadratic_spline2D(double*,double*,int,int,double,npy_intp*,npy_intp*,
                         double);
...
int D_separable_2Dconvolve_mirror(double*,double*,int,int,double*,double*,int,
                                  int,npy_intp*,npy_intp*);
