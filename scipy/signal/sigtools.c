 ...
 *-----------------------------------------------------------------------
 */
double lagrange_interp(int k, int n, int m, double *x)
{
    int j, l;
    double q, retval;
 ...
 *-----------------------------------------------------------------------
 */
double freq_eval(int k, int n, double *grid, double *x, double *y, double *ad)
{
    int j;
    double p,c,d,xf;
 ...
 *-----------------------------------------------------------------------
 */
int remez(double *dev, double des[], double grid[], double edge[],  
