...
ref struct __pyx_opt_args_5scipy_5stats_7statlib_fw_asfortranarray {
  int __pyx_n;
  int alignment;
};
...
[InteropServices::UnmanagedFunctionPointer(InteropServices::CallingConvention::Cdecl)]
public delegate NumpyDotNet::ndarray^ __pyx_delegate_t_5scipy_5stats_7statlib_fw_asfortranarray(System::Object^, int, int, __pyx_t_5numpy_intp_t *, int, int, ref struct __pyx_opt_args_5scipy_5stats_7statlib_fw_asfortranarray ^__pyx_optional_args);
...
static System::Object^ wprob(System::Object^ test, System::Object^ other, [InteropServices::Optional]System::Object^ a1) {
  ...
  if (dynamic_cast<System::Reflection::Missing^>(a1) == nullptr) {
    ...
    __pyx_v_a1 = ((System::Object^)Py_None);
  }
  __pyx_v_a1_ = nullptr;
  __pyx_v_a2_ = nullptr;
  __pyx_v_a3_ = nullptr;
 ...
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(Py_None, NPY_FLOAT, 1, __pyx_v_a2_shape, 0, 1, nullptr)); 
 ...
 *     a1_shape[0] = l1
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(Py_None, NPY_FLOAT, 1, __pyx_v_a3_shape, 0, 1, nullptr)); 
...
static System::Object^ swilk(System::Object^ x, System::Object^ a, [InteropServices::Optional]System::Object^ init, [InteropServices::Optional]System::Object^ n1) {
  ...
  if (dynamic_cast<System::Reflection::Missing^>(n1) == nullptr) {
    ...
    __pyx_v_n1 = ((System::Object^)Py_None);
  }
  __pyx_v_x_ = nullptr;
  __pyx_v_a_ = nullptr;
