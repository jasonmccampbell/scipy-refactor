...
ref struct __pyx_opt_args_5scipy_5stats_3mvn_fw_asfortranarray {
  int __pyx_n;
  int alignment;
};
...
[InteropServices::UnmanagedFunctionPointer(InteropServices::CallingConvention::Cdecl)]
public delegate NumpyDotNet::ndarray^ __pyx_delegate_t_5scipy_5stats_3mvn_fw_asfortranarray(System::Object^, int, int, __pyx_t_5numpy_intp_t *, int, int, ref struct __pyx_opt_args_5scipy_5stats_3mvn_fw_asfortranarray ^__pyx_optional_args);
...
static System::Object^ mvnun(System::Object^ lower, System::Object^ upper, System::Object^ means, System::Object^ covar, [InteropServices::Optional]System::Object^ maxpts, [InteropServices::Optional]System::Object^ abseps, [InteropServices::Optional]System::Object^ releps) {
  ...
  if (dynamic_cast<System::Reflection::Missing^>(maxpts) == nullptr) {
    ...
    __pyx_v_maxpts = ((System::Object^)Py_None);
  }
 ...
 *     inform = 0
 */
  __pyx_t_2 = (__pyx_v_maxpts != Py_None);
  if (__pyx_t_2) {
