...
static NumpyDotNet::ndarray^ fw_asfortranarray(System::Object^, int, int, __pyx_t_5numpy_intp_t *, int, int, ref struct __pyx_opt_args_5scipy_5stats_3mvn_fw_asfortranarray ^__pyx_optional_args); /*proto*/
...
static  CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >^ __site_cvt_cvt_fwr_dbl_t_23_0;
static  CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >^ __site_cvt_cvt_fwr_dbl_t_23_0_1;
static  CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >^ __site_cvt_cvt_fwi_integer_t_48_14;
...
static  CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >^ __site_cvt_cvt_fwi_integer_t_71_0;
static  CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >^ __site_cvt_cvt_fwr_dbl_t_71_0;
static  CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >^ __site_cvt_cvt_fwr_dbl_t_71_0_1;
...
static System::Object^ mvnun(System::Object^ lower, System::Object^ upper, System::Object^ means, System::Object^ covar, [InteropServices::Optional]System::Object^ maxpts, [InteropServices::Optional]System::Object^ abseps, [InteropServices::Optional]System::Object^ releps) {
  ...
  if (dynamic_cast<System::Reflection::Missing^>(abseps) == nullptr) {
    __pyx_v_abseps = __site_cvt_cvt_fwr_dbl_t_23_0->Target(__site_cvt_cvt_fwr_dbl_t_23_0, abseps);
  } else {
    __pyx_v_abseps = ((fwr_dbl_t)1e-6);
  }
  if (dynamic_cast<System::Reflection::Missing^>(releps) == nullptr) {
    __pyx_v_releps = __site_cvt_cvt_fwr_dbl_t_23_0_1->Target(__site_cvt_cvt_fwr_dbl_t_23_0_1, releps);
  } else {
 ...
 */
  ...
  __pyx_t_4 = __site_cvt_cvt_fwi_integer_t_48_14->Target(__site_cvt_cvt_fwi_integer_t_48_14, __pyx_t_1);
  __pyx_t_1 = nullptr;
...
static System::Object^ mvndst(System::Object^ lower, System::Object^ upper, System::Object^ infin, System::Object^ correl, [InteropServices::Optional]System::Object^ maxpts, [InteropServices::Optional]System::Object^ abseps, [InteropServices::Optional]System::Object^ releps) {
  ...
  if (dynamic_cast<System::Reflection::Missing^>(maxpts) == nullptr) {
    __pyx_v_maxpts = __site_cvt_cvt_fwi_integer_t_71_0->Target(__site_cvt_cvt_fwi_integer_t_71_0, maxpts);
  } else {
    __pyx_v_maxpts = ((fwi_integer_t)2000);
  }
  if (dynamic_cast<System::Reflection::Missing^>(abseps) == nullptr) {
    __pyx_v_abseps = __site_cvt_cvt_fwr_dbl_t_71_0->Target(__site_cvt_cvt_fwr_dbl_t_71_0, abseps);
  } else {
    __pyx_v_abseps = ((fwr_dbl_t)1e-6);
  }
  if (dynamic_cast<System::Reflection::Missing^>(releps) == nullptr) {
    __pyx_v_releps = __site_cvt_cvt_fwr_dbl_t_71_0_1->Target(__site_cvt_cvt_fwr_dbl_t_71_0_1, releps);
  } else {
    __pyx_v_releps = ((fwr_dbl_t)1e-6);
  }
  __pyx_v_lower_ = nullptr;
...
static void __Pyx_InitSites(CodeContext^ __pyx_context) {
  ...
  __site_cvt_cvt_fwr_dbl_t_23_0 = CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwr_dbl_t::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_fwr_dbl_t_23_0_1 = CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwr_dbl_t::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_fwi_integer_t_48_14 = CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwi_integer_t::typeid, ConversionResultKind::ExplicitCast));
  ...
  __site_cvt_cvt_fwi_integer_t_71_0 = CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwi_integer_t::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_fwr_dbl_t_71_0 = CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwr_dbl_t::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_fwr_dbl_t_71_0_1 = CallSite< System::Func< CallSite^, System::Object^, fwr_dbl_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwr_dbl_t::typeid, ConversionResultKind::ExplicitCast));
