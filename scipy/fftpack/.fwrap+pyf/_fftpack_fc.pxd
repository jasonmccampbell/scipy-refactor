...
cdef extern:
    ...
    void zfftnd(fwc_complex_x16_t * x, fwi_integer_t r, fwi_integer_t * s, fwi_integer_t direction, fwi_integer_t howmany, fwi_integer_t normalize, fwi_integer_t j)
    ...
    void cfftnd(fwc_complex_x8_t * x, fwi_integer_t r, fwi_integer_t * s, fwi_integer_t direction, fwi_integer_t howmany, fwi_integer_t normalize, fwi_integer_t j)
