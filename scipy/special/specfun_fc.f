     ...
     &fw_iserr__, fw_errstr__)
        ...
        external cbk
        fw_iserr__ = -1
        if ((200) .lt. 0 .or. (200) .gt. (ck_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if ((200) .lt. 0 .or. (200) .gt. (bk_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &fw_iserr__, fw_errstr__)
        ...
        external rmn2sp
        fw_iserr__ = -1
        if ((200) .lt. 0 .or. (200) .gt. (df_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if ((200) .lt. 0 .or. (200) .gt. (dn_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &pe__, by, dy_shape__, dy, fw_iserr__, fw_errstr__)
        ...
        external jynb
        fw_iserr__ = -1
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (bj_shape__
     &(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (by_shape__
     &(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     & fw_iserr__, fw_errstr__)
        ...
        external jynbh
        fw_iserr__ = -1
        if (((n-nmin) - (0) + 1) .lt. 0 .or. ((n-nmin) - (0) + 1) .gt. (
     &bj_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
            fw_errstr__ = transfer("bj                                  
     &                           ", fw_errstr__)
     ...
     &pe__, bk, dk_shape__, dk, fw_iserr__, fw_errstr__)
        ...
        external ikna
        fw_iserr__ = -1
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (bi_shape__
     &(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (bk_shape__
     &(1))) then
            fw_iserr__ = FW_ARR_DIM__
            fw_errstr__ = transfer("bk                                  
     &                           ", fw_errstr__)
     ...
     &by_shape__, cby, cdy_shape__, cdy, fw_iserr__, fw_errstr__)
        ...
        external cjyna
        fw_iserr__ = -1
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (cbj_shape_
     &_(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (cby_shape_
     &_(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &_, fj, fw_iserr__, fw_errstr__)
        ...
        external bjndd
        fw_iserr__ = -1
        if ((101) .lt. 0 .or. (101) .gt. (bj_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
            fw_errstr__ = transfer("bj                                  
     &                           ", fw_errstr__)
            fw_errstr__(fw_errstr_len) = C_NULL_CHAR
        ...
        if ((101) .lt. 0 .or. (101) .gt. (dj_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
            fw_errstr__ = transfer("dj                                  
     &                           ", fw_errstr__)
            fw_errstr__(fw_errstr_len) = C_NULL_CHAR
        ...
        if ((101) .lt. 0 .or. (101) .gt. (fj_shape__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &)
        ...
        external ch12n
        fw_iserr__ = -1
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (chf1_shape
     &__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (chd1_shape
     &__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (chf2_shape
     &__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (chd2_shape
     &__(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &bk_shape__, cbk, cdk_shape__, cdk, fw_iserr__, fw_errstr__)
        ...
        external ciknb
        fw_iserr__ = -1
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (cbi_shape_
     &_(1))) then
            fw_iserr__ = FW_ARR_DIM__
     ...
     &                           ", fw_errstr__)
        ...
        if (((n) - (0) + 1) .lt. 0 .or. ((n) - (0) + 1) .gt. (cbk_shape_
     &_(1))) then
            fw_iserr__ = FW_ARR_DIM__
