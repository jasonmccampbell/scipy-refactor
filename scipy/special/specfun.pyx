...
cpdef api object cbk(fwi_integer_t m, fwi_integer_t n, fwr_dbl_t c, fwr_dbl_t cv, fwr_dbl_t qt, object ck, object bk):
    ...
    """
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] ck_
    cdef fw_shape_t ck_shape_[1]
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] bk_
    cdef fw_shape_t bk_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    ck_ = np.PyArray_FROMANY(ck, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(ck_shape_, np.PyArray_DIMS(ck_), 1)
    bk_ = np.PyArray_FROMANY(bk, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
...
cpdef api object rmn2sp(fwi_integer_t m, fwi_integer_t n, fwr_dbl_t c, fwr_dbl_t x, fwr_dbl_t cv, object df, fwi_integer_t kd, fwr_dbl_t r2f, fwr_dbl_t r2d):
    ...
    """
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] df_
    cdef fw_shape_t df_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    df_ = np.PyArray_FROMANY(df, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (m, n, c, x, cv, df_, kd, r2f, r2d,)
...
cpdef api object rmn2l(fwi_integer_t m, fwi_integer_t n, fwr_dbl_t c, fwr_dbl_t x, object df, fwi_integer_t kd, fwr_dbl_t r2f, fwr_dbl_t r2d, fwi_integer_t id):
    ...
    return (m, n, c, x, df_, kd, r2f, r2d, id,)
...
cpdef api object cjk(fwi_integer_t km, object a):
    ...
    """
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] a_
    cdef fw_shape_t a_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    a_ = np.PyArray_FROMANY(a, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
...
cpdef api object kmn(fwi_integer_t m, fwi_integer_t n, fwr_dbl_t c, fwr_dbl_t cv, fwi_integer_t kd, object df, object dn, fwr_dbl_t ck1, fwr_dbl_t ck2):
    ...
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] df_
    cdef fw_shape_t df_shape_[1]
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] dn_
    cdef fw_shape_t dn_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    df_ = np.PyArray_FROMANY(df, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(df_shape_, np.PyArray_DIMS(df_), 1)
    dn_ = np.PyArray_FROMANY(dn, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (m, n, c, cv, kd, df_, dn_, ck1, ck2,)
...
cpdef api object cjyva(fwr_dbl_t v, fwc_complex_x16_t z, fwr_dbl_t vm, object cbj, object cdj, object cby, object cdy):
    ...
    """
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cbj_
    cdef fw_shape_t cbj_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cdj_
    cdef fw_shape_t cdj_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cby_
    cdef fw_shape_t cby_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cdy_
    cdef fw_shape_t cdy_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    cbj_ = np.PyArray_FROMANY(cbj, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(cbj_shape_, np.PyArray_DIMS(cbj_), 1)
    cdj_ = np.PyArray_FROMANY(cdj, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(cdj_shape_, np.PyArray_DIMS(cdj_), 1)
    cby_ = np.PyArray_FROMANY(cby, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (v, z, vm, cbj_, cdj_, cby_, cdy_,)
...
cpdef api object jyv(fwr_dbl_t v, fwr_dbl_t x, fwr_dbl_t vm, object bj, object dj, object by__, object dy):
    ...
    by___ = np.PyArray_FROMANY(by__, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (v, x, vm, bj_, dj_, by___, dy_,)
cpdef api object jynb(fwi_integer_t n, fwr_dbl_t x, fwi_integer_t nm, object bj, object dj, object by__, object dy):
    ...
    return (n, x, nm, bj_, dj_, by___, dy_,)
...
cpdef api object ikna(fwi_integer_t n, fwr_dbl_t x, fwi_integer_t nm, object bi, object di, object bk, object dk):
    ...
    """
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] bi_
    ...
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    bi_ = np.PyArray_FROMANY(bi, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
...
cpdef api object cjyna(fwi_integer_t n, fwc_complex_x16_t z, fwi_integer_t nm, object cbj, object cdj, object cby, object cdy):
    ...
    return (n, z, nm, cbj_, cdj_, cby_, cdy_,)
...
cpdef api object bjndd(fwi_integer_t n, fwr_dbl_t x, object bj, object dj, object fj):
    ...
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] dj_
    cdef fw_shape_t dj_shape_[1]
    cdef np.ndarray[fwr_dbl_t, ndim=1, mode='fortran'] fj_
    ...
    dj_ = np.PyArray_FROMANY(dj, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(dj_shape_, np.PyArray_DIMS(dj_), 1)
    fj_ = np.PyArray_FROMANY(fj, fwr_dbl_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
...
cpdef api object ch12n(fwi_integer_t n, fwc_complex_x16_t z, fwi_integer_t nm, object chf1, object chd1, object chf2, object chd2):
    ...
    """
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] chf1_
    cdef fw_shape_t chf1_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] chd1_
    cdef fw_shape_t chd1_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] chf2_
    cdef fw_shape_t chf2_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] chd2_
    cdef fw_shape_t chd2_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    chf1_ = np.PyArray_FROMANY(chf1, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(chf1_shape_, np.PyArray_DIMS(chf1_), 1)
    chd1_ = np.PyArray_FROMANY(chd1, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(chd1_shape_, np.PyArray_DIMS(chd1_), 1)
    chf2_ = np.PyArray_FROMANY(chf2, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(chf2_shape_, np.PyArray_DIMS(chf2_), 1)
    chd2_ = np.PyArray_FROMANY(chd2, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (n, z, nm, chf1_, chd1_, chf2_, chd2_,)
...
cpdef api object cikvb(fwr_dbl_t v, fwc_complex_x16_t z, fwr_dbl_t vm, object cbi, object cdi, object cbk, object cdk):
    ...
    """
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cbi_
    cdef fw_shape_t cbi_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cdi_
    cdef fw_shape_t cdi_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cbk_
    cdef fw_shape_t cbk_shape_[1]
    cdef np.ndarray[fwc_complex_x16_t, ndim=1, mode='fortran'] cdk_
    cdef fw_shape_t cdk_shape_[1]
    cdef fwi_integer_t fw_iserr__
    cdef fw_character_t fw_errstr__[fw_errstr_len]
    cbi_ = np.PyArray_FROMANY(cbi, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(cbi_shape_, np.PyArray_DIMS(cbi_), 1)
    cdi_ = np.PyArray_FROMANY(cdi, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    fw_copyshape(cdi_shape_, np.PyArray_DIMS(cdi_), 1)
    cbk_ = np.PyArray_FROMANY(cbk, fwc_complex_x16_t_enum, 1, 1, np.NPY_F_CONTIGUOUS)
    ...
    return (v, z, vm, cbi_, cdi_, cbk_, cdk_,)
...
cpdef api object ciknb(fwi_integer_t n, fwc_complex_x16_t z, fwi_integer_t nm, object cbi, object cdi, object cbk, object cdk):
    ...
    return (n, z, nm, cbi_, cdi_, cbk_, cdk_,)
