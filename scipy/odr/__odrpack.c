                  ...
                  double *fjacb, double *fjacd, int *istop)
{
  ...
  *istop = 0;
  ...
  memcpy(PyArray_DATA((PyArrayObject *) (odr_global.pyBeta)), (void *)beta,
         (*np) * sizeof(double));
                     ...
                     int full_output)
{
  ...
  dim1[0] = PyArray_DIM(beta, 0);
  sd_beta = (PyArrayObject *) PyArray_SimpleNew(1, dim1, PyArray_DOUBLE);
  dim2[0] = PyArray_DIM(beta, 0);
  dim2[1] = PyArray_DIM(beta, 0);
...
PyObject *odr(PyObject * self, PyObject * args, PyObject * kwds)
{
  ...
  if (!implicit)
    {
      ...
      n = PyArray_DIM(y, PyArray_NDIM(y) - 1);     /* pick the last dimension */
      if ((x =
      ...
      if (n != PyArray_DIM(x, PyArray_NDIM(x) - 1))
        {
          PYERR(PyExc_ValueError,
    ...
    {                           /* we *do* have an implicit model */
      ...
      n = PyArray_DIM(x, PyArray_NDIM(x) - 1);
      ldx = n;
    }
  ...
  if (pwe == NULL)
  ...
  else if (PySequence_Check(pwe))
    {
      ...
      if (PyArray_NDIM(we) == 1 && nq == 1)
      ...
      else if (PyArray_NDIM(we) == 1 && PyArray_DIM(we, 0) == nq)
        {
      ...
      else if (PyArray_NDIM(we) == 3 && PyArray_DIM(we, 0) == nq
               && PyArray_DIM(we, 1) == nq && PyArray_DIM(we, 2) == 1)
        {
      ...
      else if (PyArray_NDIM(we) == 2 && PyArray_DIM(we, 0) == nq
               && PyArray_DIM(we, 1) == nq)
        {
               ...
               && PyArray_DIM(we, 1) == n)
        {
          ...
          ld2we = 1;
               ...
               && PyArray_DIM(we, 1) == nq && PyArray_DIM(we, 2) == n)
        {
  ...
  if (pwd == NULL)
  ...
  else if (PySequence_Check(pwd))
    {
      ...
      if (PyArray_NDIM(wd) == 1 && m == 1)
      ...
      else if (PyArray_NDIM(wd) == 1 && PyArray_DIM(wd, 0) == m)
        {
      ...
      else if (PyArray_NDIM(wd) == 3 && PyArray_DIM(wd, 0) == m
               && PyArray_DIM(wd, 1) == m && PyArray_DIM(wd, 2) == 1)
        {
      ...
      else if (PyArray_NDIM(wd) == 2 && PyArray_DIM(wd, 0) == m
               && PyArray_DIM(wd, 1) == m)
        {
               ...
               && PyArray_DIM(wd, 1) == n)
        {
          ...
          ld2wd = 1;
               ...
               && PyArray_DIM(wd, 1) == m && PyArray_DIM(wd, 2) == n)
        {
  ...
  if (pifixx == NULL)
  ...
  else
    {
      ...
      if (PyArray_NDIM(ifixx) == 1 && PyArray_DIM(ifixx, 0) == m)
        {
          ldifx = 1;
        }
      else if (PyArray_NDIM(ifixx) == 1 && PyArray_DIM(ifixx, 0) == n && m == 1)
        {
          ldifx = n;
        }
      else if (PyArray_NDIM(ifixx) == 2 && PyArray_DIM(ifixx, 0) == m
               && PyArray_DIM(ifixx, 1) == n)
        {
          ldifx = n;
        }
      else
  ...
  if (pstpd == NULL)
  ...
  else
    {
      ...
      if (PyArray_NDIM(stpd) == 1 && PyArray_DIM(stpd, 0) == m)
        {
          ldstpd = 1;
        }
      else if (PyArray_NDIM(stpd) == 1 && PyArray_DIM(stpd, 0) == n && m == 1)
        {
          ldstpd = n;
        }
      else if (PyArray_NDIM(stpd) == 2 && PyArray_DIM(stpd, 0) == n &&
               PyArray_DIM(stpd, 1) == m)
        {
          ldstpd = n;
        }
    }                           /* stpd */
  ...
  if (pscld == NULL)
  ...
  else
    {
      ...
      if (PyArray_NDIM(scld) == 1 && PyArray_DIM(scld, 0) == m)
        {
          ldscld = 1;
        }
      else if (PyArray_NDIM(scld) == 1 && PyArray_DIM(scld, 0) == n && m == 1)
        {
          ldscld = n;
        }
      else if (PyArray_NDIM(scld) == 2 && PyArray_DIM(scld, 0) == n &&
               PyArray_DIM(scld, 1) == m)
        {
          ldscld = n;
        }
    }                           /* scld */
  ...
  if (pwork != NULL)
    {
      ...
      if (PyArray_DIM(work, 0) < lwork)
        {
            printf("%d %d\n", PyArray_DIM(work, 0), lwork);
