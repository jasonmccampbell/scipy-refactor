...
static CodeContext^ mk_empty_context(CodeContext^ ctx) {
  ...
  dict["__module__"] = "scipy.optimize._nnls";
...
#endif
#include <math.h>
#define __PYX_HAVE_API__scipy__optimize___nnls
...
/* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":71
 * 
 * 
...
public ref struct __pyx_opt_args_5scipy_8optimize_5_nnls_fw_asfortranarray {
  int __pyx_n;
  int alignment;
};
...
/* Module declarations from scipy.optimize._nnls_fc */
/* Module declarations from scipy.optimize._nnls */
static NumpyDotNet::ndarray^ fw_asfortranarray(System::Object^, int, int, __pyx_t_5numpy_intp_t *, int, int, ref struct __pyx_opt_args_5scipy_8optimize_5_nnls_fw_asfortranarray ^__pyx_optional_args); /*proto*/
/* Cython code section 'typeinfo' */
/* Cython code section 'before_global_var' */
#define __Pyx_MODULE_NAME "scipy.optimize._nnls"

/* Implementation of scipy.optimize._nnls */
namespace clr__nnls {
  public ref class module__nnls sealed abstract {
...
static  CallSite< System::Func< CallSite^, System::Object^, int >^ >^ __site_cvt_cvt_int_22_0;
static  CallSite< System::Func< CallSite^, System::Object^, int >^ >^ __site_cvt_cvt_int_22_0_1;
static  CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >^ __site_cvt_cvt_fwi_integer_t_53_11;
...
static  CallSite< System::Func< CallSite^, CodeContext^, System::Object^, System::Object^, System::Object^ >^ >^ __site_call1_83_27;
static  CallSite< System::Func< CallSite^, System::Object^, bool >^ >^ __site_istrue_88_59;
static  CallSite< System::Func< CallSite^, System::Object^, int >^ >^ __site_cvt_cvt_int_95_29;
static  CallSite< System::Func< CallSite^, System::Object^, System::Object^, System::Object^ >^ >^ __site_op_mod_97_60;
...
/* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":22
...
static System::Object^ nnls(System::Object^ a, System::Object^ m, System::Object^ n, System::Object^ b, System::Object^ w, System::Object^ zz, System::Object^ index_bn, [InteropServices::Optional]System::Object^ mda, [InteropServices::Optional]System::Object^ overwrite_a, [InteropServices::Optional]System::Object^ overwrite_b, [InteropServices::Optional]System::Object^ x) {
  ...
  System::Object^ __pyx_v_zz = nullptr;
  System::Object^ __pyx_v_index_bn = nullptr;
  System::Object^ __pyx_v_mda = nullptr;
  int __pyx_v_overwrite_a;
  int __pyx_v_overwrite_b;
  System::Object^ __pyx_v_x = nullptr;
  fwi_integer_t __pyx_v_mda_;
  fwi_integer_t __pyx_v_mode;
  fwr_dbl_t __pyx_v_rnorm;
  NumpyDotNet::ndarray^ __pyx_v_a_;
  NumpyDotNet::ndarray^ __pyx_v_b_;
  NumpyDotNet::ndarray^ __pyx_v_w_;
  NumpyDotNet::ndarray^ __pyx_v_zz_;
  NumpyDotNet::ndarray^ __pyx_v_index_bn_;
  NumpyDotNet::ndarray^ __pyx_v_x_;
  __pyx_t_5numpy_npy_intp __pyx_v_a_shape[2];
  __pyx_t_5numpy_npy_intp __pyx_v_b_shape[1];
  __pyx_t_5numpy_npy_intp __pyx_v_w_shape[1];
  __pyx_t_5numpy_npy_intp __pyx_v_zz_shape[1];
  __pyx_t_5numpy_npy_intp __pyx_v_index_bn_shape[1];
  ...
  __pyx_v_n = __site_cvt_cvt_fwi_integer_t_22_0_1->Target(__site_cvt_cvt_fwi_integer_t_22_0_1, n);
  __pyx_v_b = b;
  __pyx_v_w = w;
  __pyx_v_zz = zz;
  __pyx_v_index_bn = index_bn;
  if (dynamic_cast<System::Reflection::Missing^>(mda) == nullptr) {
    __pyx_v_mda = mda;
  } else {
    __pyx_v_mda = ((System::Object^)nullptr);
  }
  if (dynamic_cast<System::Reflection::Missing^>(overwrite_a) == nullptr) {
    __pyx_v_overwrite_a = __site_cvt_cvt_int_22_0->Target(__site_cvt_cvt_int_22_0, overwrite_a);
  } else {
    __pyx_v_overwrite_a = ((int)0);
  }
  if (dynamic_cast<System::Reflection::Missing^>(overwrite_b) == nullptr) {
    __pyx_v_overwrite_b = __site_cvt_cvt_int_22_0_1->Target(__site_cvt_cvt_int_22_0_1, overwrite_b);
  } else {
    __pyx_v_overwrite_b = ((int)0);
  }
  ...
  __pyx_v_w_ = nullptr;
  __pyx_v_zz_ = nullptr;
  __pyx_v_index_bn_ = nullptr;
  __pyx_v_x_ = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":50
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":51
 *     cdef np.npy_intp a_shape[2], b_shape[1], w_shape[1], zz_shape[1], index_bn_shape[1], x_shape[1]
 *     rnorm = 0
 *     mode = 0             # <<<<<<<<<<<<<<
 *     a_ = fw_asfortranarray(a, fwr_dbl_t_enum, 2, a_shape, not overwrite_a, False)
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":52
 *     rnorm = 0
 *     mode = 0
 *     a_ = fw_asfortranarray(a, fwr_dbl_t_enum, 2, a_shape, not overwrite_a, False)             # <<<<<<<<<<<<<<
 *     mda_ = mda if (mda is not None) else a_shape[0]
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":53
 *     mode = 0
 *     a_ = fw_asfortranarray(a, fwr_dbl_t_enum, 2, a_shape, not overwrite_a, False)
 *     mda_ = mda if (mda is not None) else a_shape[0]             # <<<<<<<<<<<<<<
 *     if not (a_shape[0] == mda_):
 ...
 */
  __pyx_t_2 = (__pyx_v_mda != nullptr);
  if (__pyx_t_2) {
    __pyx_t_1 = __pyx_v_mda;
  } else {
    __pyx_t_3 = (__pyx_v_a_shape[0]);
    __pyx_t_1 = __pyx_t_3;
    __pyx_t_3 = nullptr;
  }
  __pyx_t_4 = __site_cvt_cvt_fwi_integer_t_53_11->Target(__site_cvt_cvt_fwi_integer_t_53_11, __pyx_t_1);
  __pyx_t_1 = nullptr;
  __pyx_v_mda_ = __pyx_t_4;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":54
 *     a_ = fw_asfortranarray(a, fwr_dbl_t_enum, 2, a_shape, not overwrite_a, False)
 *     mda_ = mda if (mda is not None) else a_shape[0]
 *     if not (a_shape[0] == mda_):             # <<<<<<<<<<<<<<
 *         raise ValueError('Condition on arguments not satisfied: a.shape[0] == mda')
 *     if mda_ != a_shape[0]:
 */
  __pyx_t_2 = (!((__pyx_v_a_shape[0]) == __pyx_v_mda_));
  if (__pyx_t_2) {

    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":55
 *     mda_ = mda if (mda is not None) else a_shape[0]
 *     if not (a_shape[0] == mda_):
 *         raise ValueError('Condition on arguments not satisfied: a.shape[0] == mda')             # <<<<<<<<<<<<<<
 *     if mda_ != a_shape[0]:
 ...
 */
    ...
    __pyx_t_3 = __site_call1_55_24->Target(__site_call1_55_24, __pyx_context, __pyx_t_1, ((System::Object^)"Condition on arguments not satisfied: a.shape[0] == mda"));
    __pyx_t_1 = nullptr;
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":56
 *     if not (a_shape[0] == mda_):
 *         raise ValueError('Condition on arguments not satisfied: a.shape[0] == mda')
 *     if mda_ != a_shape[0]:             # <<<<<<<<<<<<<<
 *         raise ValueError("(mda == a.shape[0]) not satisifed")
 ...
 */
  __pyx_t_2 = (__pyx_v_mda_ != (__pyx_v_a_shape[0]));
  if (__pyx_t_2) {

    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":57
 *         raise ValueError('Condition on arguments not satisfied: a.shape[0] == mda')
 *     if mda_ != a_shape[0]:
 *         raise ValueError("(mda == a.shape[0]) not satisifed")             # <<<<<<<<<<<<<<
 *     b_ = fw_asfortranarray(b, fwr_dbl_t_enum, 1, b_shape, not overwrite_b, False)
 ...
 */
    ...
    __pyx_t_1 = __site_call1_57_24->Target(__site_call1_57_24, __pyx_context, __pyx_t_3, ((System::Object^)"(mda == a.shape[0]) not satisifed"));
    __pyx_t_3 = nullptr;
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":58
 *     if mda_ != a_shape[0]:
 *         raise ValueError("(mda == a.shape[0]) not satisifed")
 *     b_ = fw_asfortranarray(b, fwr_dbl_t_enum, 1, b_shape, not overwrite_b, False)             # <<<<<<<<<<<<<<
 *     w_ = fw_asfortranarray(w, fwr_dbl_t_enum, 1, w_shape, False, False)
 ...
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(__pyx_v_b, NPY_DOUBLE, 1, __pyx_v_b_shape, (!__pyx_v_overwrite_b), 0, nullptr)); 
  __pyx_v_b_ = ((NumpyDotNet::ndarray^)__pyx_t_1);
  __pyx_t_1 = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":59
 *         raise ValueError("(mda == a.shape[0]) not satisifed")
 *     b_ = fw_asfortranarray(b, fwr_dbl_t_enum, 1, b_shape, not overwrite_b, False)
 *     w_ = fw_asfortranarray(w, fwr_dbl_t_enum, 1, w_shape, False, False)             # <<<<<<<<<<<<<<
 *     zz_ = fw_asfortranarray(zz, fwr_dbl_t_enum, 1, zz_shape, False, False)
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":60
 *     b_ = fw_asfortranarray(b, fwr_dbl_t_enum, 1, b_shape, not overwrite_b, False)
 *     w_ = fw_asfortranarray(w, fwr_dbl_t_enum, 1, w_shape, False, False)
 *     zz_ = fw_asfortranarray(zz, fwr_dbl_t_enum, 1, zz_shape, False, False)             # <<<<<<<<<<<<<<
 *     index_bn_ = fw_asfortranarray(index_bn, fwi_integer_t_enum, 1, index_bn_shape, False, False)
 *     x_shape[0] = n
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(__pyx_v_zz, NPY_DOUBLE, 1, __pyx_v_zz_shape, 0, 0, nullptr)); 
  __pyx_v_zz_ = ((NumpyDotNet::ndarray^)__pyx_t_1);
  __pyx_t_1 = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":61
 *     w_ = fw_asfortranarray(w, fwr_dbl_t_enum, 1, w_shape, False, False)
 *     zz_ = fw_asfortranarray(zz, fwr_dbl_t_enum, 1, zz_shape, False, False)
 *     index_bn_ = fw_asfortranarray(index_bn, fwi_integer_t_enum, 1, index_bn_shape, False, False)             # <<<<<<<<<<<<<<
 *     x_shape[0] = n
 ...
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(__pyx_v_index_bn, NPY_INT, 1, __pyx_v_index_bn_shape, 0, 0, nullptr)); 
  __pyx_v_index_bn_ = ((NumpyDotNet::ndarray^)__pyx_t_1);
  __pyx_t_1 = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":62
 *     zz_ = fw_asfortranarray(zz, fwr_dbl_t_enum, 1, zz_shape, False, False)
 *     index_bn_ = fw_asfortranarray(index_bn, fwi_integer_t_enum, 1, index_bn_shape, False, False)
 *     x_shape[0] = n             # <<<<<<<<<<<<<<
 *     x_ = fw_asfortranarray(x, fwr_dbl_t_enum, 1, x_shape, False, True)
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":63
 *     index_bn_ = fw_asfortranarray(index_bn, fwi_integer_t_enum, 1, index_bn_shape, False, False)
 *     x_shape[0] = n
 *     x_ = fw_asfortranarray(x, fwr_dbl_t_enum, 1, x_shape, False, True)             # <<<<<<<<<<<<<<
 *     if not (0 <= n <= x_shape[0]):
 ...
 */
  __pyx_t_1 = ((System::Object^)fw_asfortranarray(__pyx_v_x, NPY_DOUBLE, 1, __pyx_v_x_shape, 0, 1, nullptr)); 
  __pyx_v_x_ = ((NumpyDotNet::ndarray^)__pyx_t_1);
  __pyx_t_1 = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":64
 *     x_shape[0] = n
 *     x_ = fw_asfortranarray(x, fwr_dbl_t_enum, 1, x_shape, False, True)
 *     if not (0 <= n <= x_shape[0]):             # <<<<<<<<<<<<<<
 *         raise ValueError("(0 <= n <= x.shape[0]) not satisifed")
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":65
 *     x_ = fw_asfortranarray(x, fwr_dbl_t_enum, 1, x_shape, False, True)
 *     if not (0 <= n <= x_shape[0]):
 *         raise ValueError("(0 <= n <= x.shape[0]) not satisifed")             # <<<<<<<<<<<<<<
 *     fc.nnls(<fwr_dbl_t*>np.PyArray_DATA(a_), &mda_, &m, &n, <fwr_dbl_t*>np.PyArray_DATA(b_), <fwr_dbl_t*>np.PyArray_DATA(x_), &rnorm, <fwr_dbl_t*>np.PyArray_DATA(w_), <fwr_dbl_t*>np.PyArray_DATA(zz_), <fwi_integer_t*>np.PyArray_DATA(index_bn_), &mode)
 ...
 */
    __pyx_t_1 = PythonOps::GetGlobal(__pyx_context, "ValueError");
    __pyx_t_3 = __site_call1_65_24->Target(__site_call1_65_24, __pyx_context, __pyx_t_1, ((System::Object^)"(0 <= n <= x.shape[0]) not satisifed"));
    __pyx_t_1 = nullptr;
    throw PythonOps::MakeException(__pyx_context, __pyx_t_3, nullptr, nullptr);
    __pyx_t_3 = nullptr;
    goto __pyx_L7;
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":66
 *     if not (0 <= n <= x_shape[0]):
 *         raise ValueError("(0 <= n <= x.shape[0]) not satisifed")
 *     fc.nnls(<fwr_dbl_t*>np.PyArray_DATA(a_), &mda_, &m, &n, <fwr_dbl_t*>np.PyArray_DATA(b_), <fwr_dbl_t*>np.PyArray_DATA(x_), &rnorm, <fwr_dbl_t*>np.PyArray_DATA(w_), <fwr_dbl_t*>np.PyArray_DATA(zz_), <fwi_integer_t*>np.PyArray_DATA(index_bn_), &mode)             # <<<<<<<<<<<<<<
 *     return (x_, rnorm, mode,)
 * 
 */
  F_FUNC(nnls,NNLS)(((fwr_dbl_t *)PyArray_DATA(__pyx_v_a_)), (&__pyx_v_mda_), (&__pyx_v_m), (&__pyx_v_n), ((fwr_dbl_t *)PyArray_DATA(__pyx_v_b_)), ((fwr_dbl_t *)PyArray_DATA(__pyx_v_x_)), (&__pyx_v_rnorm), ((fwr_dbl_t *)PyArray_DATA(__pyx_v_w_)), ((fwr_dbl_t *)PyArray_DATA(__pyx_v_zz_)), ((fwi_integer_t *)PyArray_DATA(__pyx_v_index_bn_)), (&__pyx_v_mode));

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":67
 *         raise ValueError("(0 <= n <= x.shape[0]) not satisifed")
 *     fc.nnls(<fwr_dbl_t*>np.PyArray_DATA(a_), &mda_, &m, &n, <fwr_dbl_t*>np.PyArray_DATA(b_), <fwr_dbl_t*>np.PyArray_DATA(x_), &rnorm, <fwr_dbl_t*>np.PyArray_DATA(w_), <fwr_dbl_t*>np.PyArray_DATA(zz_), <fwi_integer_t*>np.PyArray_DATA(index_bn_), &mode)
 *     return (x_, rnorm, mode,)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_3 = __pyx_v_rnorm;
  __pyx_t_1 = __pyx_v_mode;
  __pyx_t_6 = PythonOps::MakeTuple(gcnew array<System::Object^>{((System::Object^)__pyx_v_x_), __pyx_t_3, __pyx_t_1});
  __pyx_t_3 = nullptr;
  __pyx_t_1 = nullptr;
  __pyx_r = __pyx_t_6;
  __pyx_t_6 = nullptr;
...
static  NumpyDotNet::ndarray^ fw_asfortranarray(System::Object^ __pyx_v_value, int __pyx_v_typenum, int __pyx_v_ndim, __pyx_t_5numpy_intp_t *__pyx_v_coerced_shape, int __pyx_v_copy, int __pyx_v_create, ref struct __pyx_opt_args_5scipy_8optimize_5_nnls_fw_asfortranarray ^__pyx_optional_args) {
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":74
 *                                   np.intp_t * coerced_shape,
 *                                   bint copy, bint create, int alignment=1):
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":79
 *     cdef int in_ndim
 *     cdef int i
 *     if value is None:             # <<<<<<<<<<<<<<
 *         if create:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":80
 *     cdef int i
 *     if value is None:
 *         if create:             # <<<<<<<<<<<<<<
 *             result = np.PyArray_ZEROS(ndim, coerced_shape, typenum, 1)
 ...
 */
    if (__pyx_v_create) {
      ...
      /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":81
 *     if value is None:
 *         if create:
 *             result = np.PyArray_ZEROS(ndim, coerced_shape, typenum, 1)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":83
 *             result = np.PyArray_ZEROS(ndim, coerced_shape, typenum, 1)
 *         else:
 *             raise TypeError('Expected array but None provided')             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
      ...
      __pyx_t_3 = __site_call1_83_27->Target(__site_call1_83_27, __pyx_context, __pyx_t_2, ((System::Object^)"Expected array but None provided"));
      __pyx_t_2 = nullptr;
      throw PythonOps::MakeException(__pyx_context, __pyx_t_3, nullptr, nullptr);
      __pyx_t_3 = nullptr;
    }
  ...
  /*else*/ {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":85
 *             raise TypeError('Expected array but None provided')
 *     else:
 *         if ndim <= 1:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":87
 *         if ndim <= 1:
 *             # See http://projects.scipy.org/numpy/ticket/1691 for why this is needed
 *             flags |= np.NPY_C_CONTIGUOUS             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":88
 *             # See http://projects.scipy.org/numpy/ticket/1691 for why this is needed
 *             flags |= np.NPY_C_CONTIGUOUS
 *         if (not copy and alignment > 1 and np.PyArray_Check(value) and             # <<<<<<<<<<<<<<
 *             (<Py_ssize_t>np.PyArray_DATA(value) & (alignment - 1) != 0)):
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      if (__pyx_t_4) {
        ...
        __pyx_t_5 = __site_istrue_88_59->Target(__site_istrue_88_59, __pyx_t_3);
        __pyx_t_3 = nullptr;
        if (__pyx_t_5) {

          /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":89
 *             flags |= np.NPY_C_CONTIGUOUS
 *         if (not copy and alignment > 1 and np.PyArray_Check(value) and
 *             (<Py_ssize_t>np.PyArray_DATA(value) & (alignment - 1) != 0)):             # <<<<<<<<<<<<<<
 *             # mis-aligned array
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":91
 *             (<Py_ssize_t>np.PyArray_DATA(value) & (alignment - 1) != 0)):
 *             # mis-aligned array
 *             copy = True             # <<<<<<<<<<<<<<
 *         if copy:
 ...
 */
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":92
 *             # mis-aligned array
 *             copy = True
 *         if copy:             # <<<<<<<<<<<<<<
 *             flags |= np.NPY_ENSURECOPY
 ...
 */
    if (__pyx_v_copy) {
      ...
      /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":93
 *             copy = True
 *         if copy:
 *             flags |= np.NPY_ENSURECOPY             # <<<<<<<<<<<<<<
 *         result = np.PyArray_FROMANY(value, typenum, 0, 0, flags)
 ...
 */
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":94
 *         if copy:
 *             flags |= np.NPY_ENSURECOPY
 *         result = np.PyArray_FROMANY(value, typenum, 0, 0, flags)             # <<<<<<<<<<<<<<
 *     in_ndim = np.PyArray_NDIM(result)
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":95
 *             flags |= np.NPY_ENSURECOPY
 *         result = np.PyArray_FROMANY(value, typenum, 0, 0, flags)
 *     in_ndim = np.PyArray_NDIM(result)             # <<<<<<<<<<<<<<
 *     if in_ndim > ndim:
 ...
 */
  ...
  __pyx_t_9 = __site_cvt_cvt_int_95_29->Target(__site_cvt_cvt_int_95_29, __pyx_t_8);
  __pyx_t_8 = nullptr;
  __pyx_v_in_ndim = __pyx_t_9;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":96
 *         result = np.PyArray_FROMANY(value, typenum, 0, 0, flags)
 *     in_ndim = np.PyArray_NDIM(result)
 *     if in_ndim > ndim:             # <<<<<<<<<<<<<<
 *         raise ValueError("Dimension of array must be <= %d" % ndim)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":97
 *     in_ndim = np.PyArray_NDIM(result)
 *     if in_ndim > ndim:
 *         raise ValueError("Dimension of array must be <= %d" % ndim)             # <<<<<<<<<<<<<<
 *     in_shape = np.PyArray_DIMS(result)
 ...
 */
    ...
    __pyx_t_3 = __site_op_mod_97_60->Target(__site_op_mod_97_60, ((System::Object^)"Dimension of array must be <= %d"), __pyx_t_2);
    __pyx_t_2 = nullptr;
    __pyx_t_2 = __site_call1_97_24->Target(__site_call1_97_24, __pyx_context, __pyx_t_8, ((System::Object^)__pyx_t_3));
    __pyx_t_8 = nullptr;
    __pyx_t_3 = nullptr;
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":98
 *     if in_ndim > ndim:
 *         raise ValueError("Dimension of array must be <= %d" % ndim)
 *     in_shape = np.PyArray_DIMS(result)             # <<<<<<<<<<<<<<
 *     for i in range(in_ndim):
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":99
 *         raise ValueError("Dimension of array must be <= %d" % ndim)
 *     in_shape = np.PyArray_DIMS(result)
 *     for i in range(in_ndim):             # <<<<<<<<<<<<<<
 *         coerced_shape[i] = in_shape[i]
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":100
 *     in_shape = np.PyArray_DIMS(result)
 *     for i in range(in_ndim):
 *         coerced_shape[i] = in_shape[i]             # <<<<<<<<<<<<<<
 *     for i in range(in_ndim, ndim):
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":101
 *     for i in range(in_ndim):
 *         coerced_shape[i] = in_shape[i]
 *     for i in range(in_ndim, ndim):             # <<<<<<<<<<<<<<
 *         # Pad shape with ones on right side if necessarry
 ...
 */
  ...
  for (__pyx_t_11 = __pyx_v_in_ndim; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":103
 *     for i in range(in_ndim, ndim):
 *         # Pad shape with ones on right side if necessarry
 *         coerced_shape[i] = 1             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":104
 *         # Pad shape with ones on right side if necessarry
 *         coerced_shape[i] = 1
 *     return result             # <<<<<<<<<<<<<<
 * 
...
static void __Pyx_InitSites(CodeContext^ __pyx_context) {
  ...
  __site_cvt_cvt_int_22_0 = CallSite< System::Func< CallSite^, System::Object^, int >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, int::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_int_22_0_1 = CallSite< System::Func< CallSite^, System::Object^, int >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, int::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_fwi_integer_t_53_11 = CallSite< System::Func< CallSite^, System::Object^, fwi_integer_t >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, fwi_integer_t::typeid, ConversionResultKind::ExplicitCast));
  ...
  __site_call1_83_27 = CallSite< System::Func< CallSite^, CodeContext^, System::Object^, System::Object^, System::Object^ >^ >::Create(PythonOps::MakeInvokeAction(__pyx_context, CallSignature(1)));
  __site_istrue_88_59 = CallSite< System::Func< CallSite^, System::Object^, bool >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, bool::typeid, ConversionResultKind::ExplicitCast));
  __site_cvt_cvt_int_95_29 = CallSite< System::Func< CallSite^, System::Object^, int >^ >::Create(PythonOps::MakeConversionAction(__pyx_context, int::typeid, ConversionResultKind::ExplicitCast));
  __site_op_mod_97_60 = CallSite< System::Func< CallSite^, System::Object^, System::Object^, System::Object^ >^ >::Create(PythonOps::MakeBinaryOperationAction(__pyx_context, ExpressionType::Modulo));
...
static void PerformModuleReload(PythonContext^ context, PythonDictionary^ dict) {
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":18
 ...
 */
  ...
  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":19
 * 
 * np.import_array()
 * __all__ = ['nnls']             # <<<<<<<<<<<<<<
 * cdef extern from "string.h":
 *     void *memcpy(void *dest, void *src, size_t n)
 */
  __pyx_t_1 = PythonOps::MakeListNoCopy(gcnew array<System::Object^>{((System::Object^)"nnls")});
  PythonOps::SetGlobal(__pyx_context, "__all__", ((System::Object^)__pyx_t_1));
  __pyx_t_1 = nullptr;

  /* "Z:\dev\scipy-refactor\scipy\optimize\_nnls.pyx":1
...
[assembly: PythonModule("scipy__optimize___nnls", module__nnls::typeid)];
};
