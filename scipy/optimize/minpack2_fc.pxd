...
cdef extern from "minpack2_fc.h":
    void dcsrch(fwr_dbl_t * stp, fwr_dbl_t * f, fwr_dbl_t * g, fwr_dbl_t * ftol, fwr_dbl_t * gtol, fwr_dbl_t * xtol, char * task, fwr_dbl_t * stpmin, fwr_dbl_t * stpmax, fwi_integer_t * isave, fwr_dbl_t * dsave, size_t task_len_)
